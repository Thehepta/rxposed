...
//        }
    ...
    void HOOK_Process_setArgv0(JNIEnv *env) {
        ...
        jmethodID javamethod = env->GetStaticMethodID(Process_cls, "setArgV0",
                                                      "(Ljava/lang/String;)V");
        android_os_Process_setArg_org = reinterpret_cast<void (*)(JNIEnv *, jclass,
...
//    nativeSpecializeAppProcess_org 函数必须后调用，发起contextprovider请求才能成功
        ...
        jmethodID nativeSpecializeAppProcess_method = env->GetStaticMethodID(clazz,
