...
struct soinfo_12_transform;
void android_12_soinfo_transform(soinfo*, soinfo_12_transform *);
...
private:
    ...
    DISALLOW_COPY_AND_ASSIGN(LinkedList_12);
};


typedef LinkedList_12<soinfo, SoinfoListAllocator> soinfo_list_t_12;
typedef LinkedList_12<android_namespace_t, NamespaceListAllocator> android_namespace_list_t_12;
