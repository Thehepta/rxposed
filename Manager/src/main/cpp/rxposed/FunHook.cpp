...
//    if(getUidForName == NULL){
//        getUidForName = rxposed::resolve_elf_internal_symbol("/system/lib64/libandroid_runtime.so","_Z32android_os_Process_getUidForNameP7_JNIEnvP8_jobjectP8_jstring");
//    }
