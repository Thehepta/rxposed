...
class ModulesFragment : Fragment() {
    ...
    private val filterModuleInfo: List<ModuleInfo> = ArrayList()
...
//        )
    ...
    private fun initRecycleView() {
        ...
        moduleListAdapter!!.setOnItemClickListener { adapter, view, position ->
            val moduleInfo = adapter.data[position] as ModuleInfo
...
//            controller.navigate(R.id.apps_dest)
        ...
        moduleListAdapter!!.setList(ModuleInfoProvider.getInstance().moduleList)
