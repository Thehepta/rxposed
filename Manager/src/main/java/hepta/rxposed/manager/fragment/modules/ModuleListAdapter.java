...
public class ModuleListAdapter extends BaseQuickAdapter<ModuleInfo, BaseViewHolder> implements LoadMoreModule {
...
//    }
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder baseViewHolder, ModuleInfo item) {
        if (item == null) {
            return;
        }
