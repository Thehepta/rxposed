...
import hepta.rxposed.manager.fragment.PlugSupport.apps.AppInfoAdapter
...
class ApplistFragment : baseCollToolbarFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val firstSectionBar = SectionBarNode(ExtendData.getInstance().moduleList as List<BaseNode>?, "依赖应用")
        Datalist.add(firstSectionBar)
        val secondSectionBar =
            SectionBarNode(moduleInfo?.appInfoList as List<BaseNode>?,
                "应用列表"
            )
